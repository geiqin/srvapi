...
type BuyingService interface {
	// 获取配送信息
	GetData(ctx context.Context, in *Buying, opts ...client.CallOption) (*BuyingResponse, error)
}
...
func (c *buyingService) GetData(ctx context.Context, in *Buying, opts ...client.CallOption) (*BuyingResponse, error) {
	req := c.c.NewRequest(c.name, "BuyingService.GetData", in)
...
type BuyingServiceHandler interface {
	// 获取配送信息
	GetData(context.Context, *Buying, *BuyingResponse) error
}

func RegisterBuyingServiceHandler(s server.Server, hdlr BuyingServiceHandler, opts ...server.HandlerOption) error {
	type buyingService interface {
		GetData(ctx context.Context, in *Buying, out *BuyingResponse) error
	}
	type BuyingService struct {
		buyingService
	}
...
func (h *buyingServiceHandler) GetData(ctx context.Context, in *Buying, out *BuyingResponse) error {
	return h.BuyingServiceHandler.GetData(ctx, in, out)
}
