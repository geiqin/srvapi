...
type ShipperService interface {
	...
	Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*ShipperResponse, error)
	List(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*ShipperResponse, error)
}
...
func (c *shipperService) Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*ShipperResponse, error) {
...
func (c *shipperService) List(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*ShipperResponse, error) {
...
type ShipperServiceHandler interface {
	...
	Search(context.Context, *BaseWhere, *ShipperResponse) error
	List(context.Context, *BaseWhere, *ShipperResponse) error
}
...
func RegisterShipperServiceHandler(s server.Server, hdlr ShipperServiceHandler, opts ...server.HandlerOption) error {
	type shipperService interface {
		...
		Search(ctx context.Context, in *BaseWhere, out *ShipperResponse) error
		List(ctx context.Context, in *BaseWhere, out *ShipperResponse) error
	}
	type ShipperService struct {
		shipperService
	}
...
func (h *shipperServiceHandler) Search(ctx context.Context, in *BaseWhere, out *ShipperResponse) error {
	return h.ShipperServiceHandler.Search(ctx, in, out)
}

func (h *shipperServiceHandler) List(ctx context.Context, in *BaseWhere, out *ShipperResponse) error {
