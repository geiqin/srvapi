...
type ExpressCfgService interface {
	// 启用快递发货功能
	Open(ctx context.Context, in *Empty, opts ...client.CallOption) (*SettingResponse, error)
	// 关闭快递发货功能
	Close(ctx context.Context, in *Empty, opts ...client.CallOption) (*SettingResponse, error)
	// 检查快递发货功能是否开启
	IsOpen(ctx context.Context, in *Empty, opts ...client.CallOption) (*SettingResponse, error)
	// 获取快递发货配置
	Get(ctx context.Context, in *Empty, opts ...client.CallOption) (*SettingResponse, error)
	// 修改运费模板计费方式
...
func (c *expressCfgService) Open(ctx context.Context, in *Empty, opts ...client.CallOption) (*SettingResponse, error) {
...
func (c *expressCfgService) Close(ctx context.Context, in *Empty, opts ...client.CallOption) (*SettingResponse, error) {
...
func (c *expressCfgService) IsOpen(ctx context.Context, in *Empty, opts ...client.CallOption) (*SettingResponse, error) {
...
func (c *expressCfgService) Get(ctx context.Context, in *Empty, opts ...client.CallOption) (*SettingResponse, error) {
...
type ExpressCfgServiceHandler interface {
	// 启用快递发货功能
	Open(context.Context, *Empty, *SettingResponse) error
	// 关闭快递发货功能
	Close(context.Context, *Empty, *SettingResponse) error
	// 检查快递发货功能是否开启
	IsOpen(context.Context, *Empty, *SettingResponse) error
	// 获取快递发货配置
	Get(context.Context, *Empty, *SettingResponse) error
	// 修改运费模板计费方式
...
func RegisterExpressCfgServiceHandler(s server.Server, hdlr ExpressCfgServiceHandler, opts ...server.HandlerOption) error {
	type expressCfgService interface {
		Open(ctx context.Context, in *Empty, out *SettingResponse) error
		Close(ctx context.Context, in *Empty, out *SettingResponse) error
		IsOpen(ctx context.Context, in *Empty, out *SettingResponse) error
		Get(ctx context.Context, in *Empty, out *SettingResponse) error
...
func (h *expressCfgServiceHandler) Open(ctx context.Context, in *Empty, out *SettingResponse) error {
	return h.ExpressCfgServiceHandler.Open(ctx, in, out)
}

func (h *expressCfgServiceHandler) Close(ctx context.Context, in *Empty, out *SettingResponse) error {
	return h.ExpressCfgServiceHandler.Close(ctx, in, out)
}

func (h *expressCfgServiceHandler) IsOpen(ctx context.Context, in *Empty, out *SettingResponse) error {
	return h.ExpressCfgServiceHandler.IsOpen(ctx, in, out)
}

func (h *expressCfgServiceHandler) Get(ctx context.Context, in *Empty, out *SettingResponse) error {
