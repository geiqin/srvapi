...
func (c *deliveryCfgService) Open(ctx context.Context, in *Empty, opts ...client.CallOption) (*SettingResponse, error) {
...
func (c *deliveryCfgService) Close(ctx context.Context, in *Empty, opts ...client.CallOption) (*SettingResponse, error) {
...
func (c *deliveryCfgService) IsOpen(ctx context.Context, in *Empty, opts ...client.CallOption) (*SettingResponse, error) {
...
func (h *deliveryCfgServiceHandler) Open(ctx context.Context, in *Empty, out *SettingResponse) error {
	return h.DeliveryCfgServiceHandler.Open(ctx, in, out)
}

func (h *deliveryCfgServiceHandler) Close(ctx context.Context, in *Empty, out *SettingResponse) error {
	return h.DeliveryCfgServiceHandler.Close(ctx, in, out)
}

func (h *deliveryCfgServiceHandler) IsOpen(ctx context.Context, in *Empty, out *SettingResponse) error {
