...
type OrderCouponService interface {
	...
	Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*OrderCouponResponse, error)
}
...
func (c *orderCouponService) Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*OrderCouponResponse, error) {
...
type OrderCouponServiceHandler interface {
	...
	Search(context.Context, *BaseWhere, *OrderCouponResponse) error
}
...
func RegisterOrderCouponServiceHandler(s server.Server, hdlr OrderCouponServiceHandler, opts ...server.HandlerOption) error {
	type orderCouponService interface {
		...
		Search(ctx context.Context, in *BaseWhere, out *OrderCouponResponse) error
	}
	type OrderCouponService struct {
		orderCouponService
	}
...
func (h *orderCouponServiceHandler) Search(ctx context.Context, in *BaseWhere, out *OrderCouponResponse) error {
