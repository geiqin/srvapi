...
type InvoiceService interface {
	...
	Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*InvoiceResponse, error)
}
...
func (c *invoiceService) Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*InvoiceResponse, error) {
...
type InvoiceServiceHandler interface {
	...
	Search(context.Context, *BaseWhere, *InvoiceResponse) error
}
...
func RegisterInvoiceServiceHandler(s server.Server, hdlr InvoiceServiceHandler, opts ...server.HandlerOption) error {
	type invoiceService interface {
		...
		Search(ctx context.Context, in *BaseWhere, out *InvoiceResponse) error
	}
	type InvoiceService struct {
		invoiceService
	}
...
func (h *invoiceServiceHandler) Search(ctx context.Context, in *BaseWhere, out *InvoiceResponse) error {
