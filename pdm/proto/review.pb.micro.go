...
func (c *reviewService) Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*ReviewResponse, error) {
...
func (h *reviewServiceHandler) Search(ctx context.Context, in *BaseWhere, out *ReviewResponse) error {
