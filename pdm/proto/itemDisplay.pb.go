...
type ItemDisplay struct {
	...
	Cats                  []*Cat         `protobuf:"bytes,26,rep,name=cats,proto3" json:"cats"`
	Tags                  []*Tag         `protobuf:"bytes,27,rep,name=tags,proto3" json:"tags"`
	...
	Specs                 []*Spec        `protobuf:"bytes,30,rep,name=specs,proto3" json:"specs"`
