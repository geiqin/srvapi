...
type Item struct {
	...
	Cats                 []*Cat           `protobuf:"bytes,42,rep,name=cats,proto3" json:"cats"`
	Tags                 []*Tag           `protobuf:"bytes,43,rep,name=tags,proto3" json:"tags"`
	...
	SpecIndexes          []*SpecItemIndex `protobuf:"bytes,48,rep,name=spec_indexes,json=specIndexes,proto3" json:"spec_indexes"`
	Ids                  []int64          `protobuf:"varint,49,rep,packed,name=ids,proto3" json:"ids"`
	Specs                []*Spec          `protobuf:"bytes,50,rep,name=specs,proto3" json:"specs"`
	Skuitem              *Sku             `protobuf:"bytes,51,opt,name=skuitem,proto3" json:"skuitem"`
	SkuId                int64            `protobuf:"varint,52,opt,name=sku_id,json=skuId,proto3" json:"sku_id"`
...
type ItemWhere struct {
	...
	Valid                bool     `protobuf:"varint,16,opt,name=valid,proto3" json:"valid"`
	Invite               string   `protobuf:"bytes,17,opt,name=invite,proto3" json:"invite"`
	Id                   int64    `protobuf:"varint,18,opt,name=id,proto3" json:"id"`
	Ids                  []int64  `protobuf:"varint,19,rep,packed,name=ids,proto3" json:"ids"`
	SkuId                int64    `protobuf:"varint,20,opt,name=sku_id,json=skuId,proto3" json:"sku_id"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
