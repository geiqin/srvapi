...
type MyWechatService interface {
	//记录推荐人
	Recommender(ctx context.Context, in *Wechat, opts ...client.CallOption) (*TokenResponse, error)
	//记录分享痕迹
	WriteShare(ctx context.Context, in *Wechat, opts ...client.CallOption) (*TokenResponse, error)
	//记录追踪痕迹
...
func (c *myWechatService) Recommender(ctx context.Context, in *Wechat, opts ...client.CallOption) (*TokenResponse, error) {
...
func (c *myWechatService) WriteShare(ctx context.Context, in *Wechat, opts ...client.CallOption) (*TokenResponse, error) {
...
type MyWechatServiceHandler interface {
	//记录推荐人
	Recommender(context.Context, *Wechat, *TokenResponse) error
	//记录分享痕迹
	WriteShare(context.Context, *Wechat, *TokenResponse) error
	//记录追踪痕迹
...
func RegisterMyWechatServiceHandler(s server.Server, hdlr MyWechatServiceHandler, opts ...server.HandlerOption) error {
	type myWechatService interface {
		Recommender(ctx context.Context, in *Wechat, out *TokenResponse) error
		WriteShare(ctx context.Context, in *Wechat, out *TokenResponse) error
...
func (h *myWechatServiceHandler) Recommender(ctx context.Context, in *Wechat, out *TokenResponse) error {
	return h.MyWechatServiceHandler.Recommender(ctx, in, out)
}

func (h *myWechatServiceHandler) WriteShare(ctx context.Context, in *Wechat, out *TokenResponse) error {
