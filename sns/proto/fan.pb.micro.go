...
type MyFanService interface {
	Info(ctx context.Context, in *Empty, opts ...client.CallOption) (*FanResponse, error)
}
...
func NewMyFanService(name string, c client.Client) MyFanService {
	return &myFanService{
		c:    c,
		name: name,
	}
...
func (c *myFanService) Info(ctx context.Context, in *Empty, opts ...client.CallOption) (*FanResponse, error) {
...
type MyFanServiceHandler interface {
	Info(context.Context, *Empty, *FanResponse) error
}

func RegisterMyFanServiceHandler(s server.Server, hdlr MyFanServiceHandler, opts ...server.HandlerOption) error {
	type myFanService interface {
		Info(ctx context.Context, in *Empty, out *FanResponse) error
	}
	type MyFanService struct {
		myFanService
	}
	h := &myFanServiceHandler{hdlr}
	return s.Handle(s.NewHandler(&MyFanService{h}, opts...))
}

type myFanServiceHandler struct {
	MyFanServiceHandler
}

func (h *myFanServiceHandler) Info(ctx context.Context, in *Empty, out *FanResponse) error {
