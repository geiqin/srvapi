...
type MyLeaderStatementService interface {
	//获取分红收支明细
	Get(ctx context.Context, in *LeaderStatement, opts ...client.CallOption) (*LeaderStatementResponse, error)
	//查询分红收支明细
	Search(ctx context.Context, in *LeaderStatementWhere, opts ...client.CallOption) (*LeaderStatementResponse, error)
}
...
func (c *myLeaderStatementService) Get(ctx context.Context, in *LeaderStatement, opts ...client.CallOption) (*LeaderStatementResponse, error) {
	req := c.c.NewRequest(c.name, "MyLeaderStatementService.Get", in)
	out := new(LeaderStatementResponse)
...
func (c *myLeaderStatementService) Search(ctx context.Context, in *LeaderStatementWhere, opts ...client.CallOption) (*LeaderStatementResponse, error) {
...
type MyLeaderStatementServiceHandler interface {
	//获取分红收支明细
	Get(context.Context, *LeaderStatement, *LeaderStatementResponse) error
	//查询分红收支明细
	Search(context.Context, *LeaderStatementWhere, *LeaderStatementResponse) error
}
...
func RegisterMyLeaderStatementServiceHandler(s server.Server, hdlr MyLeaderStatementServiceHandler, opts ...server.HandlerOption) error {
	type myLeaderStatementService interface {
		Get(ctx context.Context, in *LeaderStatement, out *LeaderStatementResponse) error
		Search(ctx context.Context, in *LeaderStatementWhere, out *LeaderStatementResponse) error
	}
	type MyLeaderStatementService struct {
...
func (h *myLeaderStatementServiceHandler) Get(ctx context.Context, in *LeaderStatement, out *LeaderStatementResponse) error {
	return h.MyLeaderStatementServiceHandler.Get(ctx, in, out)
}

func (h *myLeaderStatementServiceHandler) Search(ctx context.Context, in *LeaderStatementWhere, out *LeaderStatementResponse) error {
...
func (c *leaderStatementService) Get(ctx context.Context, in *LeaderStatement, opts ...client.CallOption) (*LeaderStatementResponse, error) {
...
func (c *leaderStatementService) Search(ctx context.Context, in *LeaderStatementWhere, opts ...client.CallOption) (*LeaderStatementResponse, error) {
...
func (h *leaderStatementServiceHandler) Get(ctx context.Context, in *LeaderStatement, out *LeaderStatementResponse) error {
	return h.LeaderStatementServiceHandler.Get(ctx, in, out)
}

func (h *leaderStatementServiceHandler) Search(ctx context.Context, in *LeaderStatementWhere, out *LeaderStatementResponse) error {
