...
type DistRewardCfgService interface {
	Get(ctx context.Context, in *Empty, opts ...client.CallOption) (*DistRewardCfgResponse, error)
...
func (c *distRewardCfgService) Get(ctx context.Context, in *Empty, opts ...client.CallOption) (*DistRewardCfgResponse, error) {
...
type DistRewardCfgServiceHandler interface {
	Get(context.Context, *Empty, *DistRewardCfgResponse) error
...
func RegisterDistRewardCfgServiceHandler(s server.Server, hdlr DistRewardCfgServiceHandler, opts ...server.HandlerOption) error {
	type distRewardCfgService interface {
		Get(ctx context.Context, in *Empty, out *DistRewardCfgResponse) error
...
func (h *distRewardCfgServiceHandler) Get(ctx context.Context, in *Empty, out *DistRewardCfgResponse) error {
