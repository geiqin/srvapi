...
func (c *myLeaderApplierService) Apply(ctx context.Context, in *Empty, opts ...client.CallOption) (*ApplyInfoResponse, error) {
...
func (h *myLeaderApplierServiceHandler) Apply(ctx context.Context, in *Empty, out *ApplyInfoResponse) error {
...
func (c *leaderApplierService) Search(ctx context.Context, in *ApplierWhere, opts ...client.CallOption) (*ApplierResponse, error) {
...
func (h *leaderApplierServiceHandler) Search(ctx context.Context, in *ApplierWhere, out *ApplierResponse) error {
