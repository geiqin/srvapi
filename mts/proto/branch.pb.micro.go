...
type BranchService interface {
	...
	Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*BranchResponse, error)
}
...
func (c *branchService) Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*BranchResponse, error) {
...
type BranchServiceHandler interface {
	...
	Search(context.Context, *BaseWhere, *BranchResponse) error
}
...
func RegisterBranchServiceHandler(s server.Server, hdlr BranchServiceHandler, opts ...server.HandlerOption) error {
	type branchService interface {
		...
		Search(ctx context.Context, in *BaseWhere, out *BranchResponse) error
	}
	type BranchService struct {
		branchService
	}
...
func (h *branchServiceHandler) Search(ctx context.Context, in *BaseWhere, out *BranchResponse) error {
