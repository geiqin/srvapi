...
type TaxonomyService interface {
	...
	Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*TaxonomyResponse, error)
...
func (c *taxonomyService) Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*TaxonomyResponse, error) {
...
type TaxonomyServiceHandler interface {
	...
	Search(context.Context, *BaseWhere, *TaxonomyResponse) error
...
func RegisterTaxonomyServiceHandler(s server.Server, hdlr TaxonomyServiceHandler, opts ...server.HandlerOption) error {
	type taxonomyService interface {
		...
		Search(ctx context.Context, in *BaseWhere, out *TaxonomyResponse) error
...
func (h *taxonomyServiceHandler) Search(ctx context.Context, in *BaseWhere, out *TaxonomyResponse) error {
