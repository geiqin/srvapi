...
type RoleService interface {
	...
	Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*RoleResponse, error)
}
...
func (c *roleService) Search(ctx context.Context, in *BaseWhere, opts ...client.CallOption) (*RoleResponse, error) {
...
type RoleServiceHandler interface {
	...
	Search(context.Context, *BaseWhere, *RoleResponse) error
}
...
func RegisterRoleServiceHandler(s server.Server, hdlr RoleServiceHandler, opts ...server.HandlerOption) error {
	type roleService interface {
		...
		Search(ctx context.Context, in *BaseWhere, out *RoleResponse) error
	}
	type RoleService struct {
		roleService
	}
...
func (h *roleServiceHandler) Search(ctx context.Context, in *BaseWhere, out *RoleResponse) error {
