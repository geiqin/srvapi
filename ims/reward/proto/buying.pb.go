...
type Buying struct {
	...
	Items                []*BuyingItem   `protobuf:"bytes,8,rep,name=items,proto3" json:"items"`
	Coupons              []*RewardCoupon `protobuf:"bytes,9,rep,name=coupons,proto3" json:"coupons"`
	Changed              bool            `protobuf:"varint,10,opt,name=changed,proto3" json:"changed"`
...
type BuyingItem struct {
	...
	IsGift               bool     `protobuf:"varint,8,opt,name=is_gift,json=isGift,proto3" json:"is_gift"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
